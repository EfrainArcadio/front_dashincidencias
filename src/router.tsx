...
import EditCorredorView from "./views/corredores/EditCorredorView";
    ...
    <BrowserRouter>
      <Routes>
        <Route element={<AppLayout />}>
          ...
          <Route path="/integrador/:empresaId/edit" element={<EditIntegradorview />} />
          ...
          <Route path="/corredor/:empresaId/edit" element={<EditCorredorView />} />
