    ...
    return (
      <>
        ...
        {data ? (
          ...
          >
            <li key={data._id} className="flex justify-between gap-x-4 px-3 py-5 bg-white divide-gray-100 border border-gray-100 mt-2 shadow-white shadow-sm w-[280px] ms:w-[300px] md:w-[310px ] lg:w-[320px] xl:w-[330px]">
...
export default AddManagerIntegrador;
